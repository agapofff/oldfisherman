...
function qtranxf_add_language_menu_item( &$items, &$menu_order, &$itemid, $key, $language ) {
    ...
    if ( $topflag ) {
        ...
        $item->title .= '<img class="qtranxs-flag" src="' . $flag_location . $q_config['flag'][ $toplang ] . '" alt="' . $q_config['language_name'][ $toplang ] . '" />&nbsp;' . $q_config['language_name'][ $toplang ];//.' '.__('Flag', 'qtranslate')
    }
