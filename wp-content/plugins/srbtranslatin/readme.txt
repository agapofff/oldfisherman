...
* Minimum WP version bumped to 5.3
* Minimum PHP version bumped to **7.2**
* Fixed plugin namespaces, old functions can still be used without namespace, but they will throw **E_USER_DEPRECATED** error
* Transliteration engine reworked to transliterate content based on cookie value

Improvements:

* **Added Ajax transliteration support**
* Removed unneded settings screen
* Removed advertisement from settings screen
* Removed Expert mode settings filter
* Simplified settings screen
* Improved plugin performance

Bug fixes:

* Fixed PHP Fatal Error in various scenarios
* Fixed PHP notices and warnings in various scenarios
* Fixed shortcode functions and plugin functions
